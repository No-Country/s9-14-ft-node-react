  ...
  const handleToggleMenu = () => {
    ...
    <div className={style.membership}>
      <Head>
        ...
        <h1 className={`${style.title} ${style.color_orange} ${isOpen ? style.hidden : ''}`}>PLAN DE MEMBRESIAS</h1>
        <section className={`${style.plans} ${isOpen ? style.hidden : ''}`}>
